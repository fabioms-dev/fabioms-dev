...
- 👩‍💻 Com mais de 8 anos de experiência na área de programação  
- 🌟 Já trabalhei em empresas como **Base2 Tecnologia, Santander, Localiza e Framework Digital**  


## 🛠️ Tecnologias e Ferramentas que possuo experiência

- 🧾 **Linguagens**: C# | Ruby | Python | JavaScript
- ⚙️ **Frameworks**: .NET Core | .NET | Ruby and Rails
